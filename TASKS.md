...
- [ ] **NEF-T002 Reproducible scaffold and trusted CI.** Implementation and local verification complete on `feat/NEF-T002-reproducible-scaffold`; checkpoint push, draft PR, GitHub CI/review, and merge approval remain. Scope: Python 3.12/uv lock, module skeleton, deterministic quality/security CI, trusted-base advisory Anthropic spec-blind reviewer, RFC 8032 known-answer coverage, constitution 1.1.0 plus target-pinning contract 2.0.0 amendment, Draft 2020-12 immutable-target vectors, and m0 gate/provisional target profiles.
